...
public class Ruta {
    ...
    private List<Modelobarco> modelosconxruta = new ArrayList<>();
    ...
    public List<Modelobarco> getModelosconxruta() {
        return modelosconxruta;
    }

    public void setModelosconxruta(List<Modelobarco> modelosconxruta) {
